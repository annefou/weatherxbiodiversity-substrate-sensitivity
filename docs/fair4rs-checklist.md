...
| FORRT Outcome's `Repository URL` field | Points to `https://github.com/annefou/weatherxbiodiversity-substrate-sensitivity`. |
...
| GHCR Docker pull | `docker pull ghcr.io/annefou/weatherxbiodiversity-substrate-sensitivity:latest` over HTTPS. |
